...
This is a mess! We need to cook our own PCA plot. To do this we need to access the results within the `wisc.pr` object. 
...
There is a separation of the red (cancer) from black (non-cancer) samples. 
